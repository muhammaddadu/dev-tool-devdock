...
- [Port detection](./architecture/port-detection.md)
- [Process management](./architecture/process-management.md)
...
- [Running locally](./engineering/running-locally.md)
...
- [UI overview](./design/ui-overview.md)
- [ASCII flows](./design/ascii-flows.md)
...
- [ADR-0001: Tauri + Rust + React](./decisions/adr-0001-tauri-rust-react.md)
- [ADR-0002: macOS first](./decisions/adr-0002-macos-first.md)
- [ADR-0003: SQLite storage](./decisions/adr-0003-sqlite-storage.md)
- [ADR-0004: Adapter architecture](./decisions/adr-0004-adapter-architecture.md)
